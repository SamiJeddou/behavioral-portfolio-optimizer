...
""", unsafe_allow_html=True)
  ...
  <div style="position:relative;display:inline-block;width:160px">
    ...
    st.markdown(
        "📄 **[Download the User Guide (PDF)](app/static/Beyond_Mean_Variance_Portfolio_Optimiser_User_Guide.pdf)** — step-by-step guide to using the app",
