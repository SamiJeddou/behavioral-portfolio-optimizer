...
/* AI-powered expander — lighter navy background with blue border */
    section[data-testid="stSidebar"] details{background:#0d1f35 !important;border:1px solid #1a6bbf !important;border-radius:6px !important;margin-top:.3rem !important}
    section[data-testid="stSidebar"] details summary{color:#7fb3e8 !important;font-size:.85rem !important}
