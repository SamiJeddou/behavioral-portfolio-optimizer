...
def plot_frontier_plotly(mv_x, mv_y, mv_eq,
    ...
    if mv_eq:
        fig.add_trace(go.Scatter(
            ...
            name='Equivalence point — MV = Behavioural (no derivatives) where λ=3.795 ↔ H=-10%, α=5%',
...
with tab1:
    ...
    # ── Finance banner ────────────────────────────────────────────────────────
    st.markdown(f'''
<div style="width:100%;background:linear-gradient(135deg,#020c1b 0%,#071428 40%,#0a1a35 70%,#020c1b 100%);border-radius:12px;overflow:hidden;border:1px solid #1a3a5c;display:flex;align-items:stretch;font-family:monospace;margin-bottom:1rem">
  ...
  <div style="flex:3.2;display:grid;grid-template-columns:repeat(4,1fr)">
    ...
    <div style="border-right:1px solid #1a3a5c;display:flex;flex-direction:column">
      ...
      <div style="padding:7px 10px;flex:1;display:flex;flex-direction:column;justify-content:center;text-align:center">
        <div style="color:rgba(100,140,200,0.65);font-size:7px;letter-spacing:0.15em;margin-bottom:3px">LIVE MARKET DATA</div>
    ...
    <div style="border-right:1px solid #1a3a5c;display:flex;flex-direction:column">
      ...
      <div style="padding:7px 10px;flex:1;display:flex;flex-direction:column;justify-content:center;text-align:center">
        <div style="color:rgba(100,140,200,0.65);font-size:7px;letter-spacing:0.15em;margin-bottom:3px">RETURN — WITH CGN</div>
    ...
    <div style="border-right:1px solid #1a3a5c;display:flex;flex-direction:column">
      ...
      <div style="padding:7px 10px;flex:1;display:flex;flex-direction:column;justify-content:center;text-align:center">
        <div style="color:rgba(100,140,200,0.65);font-size:7px;letter-spacing:0.15em;margin-bottom:3px">RETURN — NO DERIV.</div>
    ...
    <div style="display:flex;flex-direction:column">
      ...
      <div style="padding:7px 10px;flex:1;display:flex;flex-direction:column;justify-content:center;text-align:center">
        <div style="color:rgba(100,140,200,0.65);font-size:7px;letter-spacing:0.15em;margin-bottom:3px">DERIVATIVE TYPES</div>
