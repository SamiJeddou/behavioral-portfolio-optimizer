...
if _view == "optimiser":
    import os
    st.markdown('<h2 style="color:#4a9eff;margin-bottom:2px">Exact Portfolio Optimiser</h2><div style="color:#8b949e;font-size:0.95rem;margin-bottom:6px">Behavioural mean-variance with derivatives &amp; structured products — Das–Statman mental-accounts framework</div>', unsafe_allow_html=True)
    st.markdown(
