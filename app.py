  ...
  <div style="flex:3.2;display:grid;grid-template-columns:repeat(5,1fr)">
    ...
    <div style="display:flex;flex-direction:column">
      ...
      <div style="border-left:1px solid #1a3a5c;display:flex;flex-direction:column">
        <div style="height:82px;overflow:hidden;border-bottom:1px solid #0d2a4a;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;padding:8px">
